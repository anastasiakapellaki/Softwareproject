 ...
 * @author admin
 */
public class ManagerErrorData extends javax.swing.JFrame {

    /** Creates new form ManagerErrorData */
    public ManagerErrorData() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Εισάγετε ξανά τα στοιχεία!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerErrorData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerErrorData().setVisible(true);
            }
        });
    }
