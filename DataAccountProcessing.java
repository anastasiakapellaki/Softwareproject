 ...
 * @author admin
 */
public class DataAccountProcessing extends javax.swing.JFrame {

    /**
     * Creates new form DataAccountProcessing
     */
    public DataAccountProcessing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ΕΠΕΞΕΡΓΑΣΙΑ ΣΤΟΙΧΕΙΩΝ ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataAccountProcessing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataAccountProcessing().setVisible(true);
            }
        });
    }
